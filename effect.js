...
$('document').ready(function(){
		...
		$(window).resize(function(){
			...
			$('#b01').animate({top:140, left: vw-200},500);
			$('#b22').animate({top:140, left: vw-100},500);
			$('#b33').animate({top:140, left: vw+0},500);
			$('#b44').animate({top:140, left: vw+100},500);
			$('#b55').animate({top:240, left: vw-240},500);
			...
			$('#b100').animate({top:340, left: vw-200},500);
			$('#b111').animate({top:340, left: vw-100},500);
			$('#b122').animate({top:340, left: vw+0},500);
			$('#b133').animate({top:340, left: vw+100},500);	
			});
	...
	$('#balloons_flying').click(function(){
		...
		$('#b1,#b4,#b5,#b7,#b8,#b11,#b12').addClass('balloons-rotate-behaviour-one');
		$('#b2,#b3,#b6,#b9,#b10,#b13').addClass('balloons-rotate-behaviour-two');
		...
		// $('#b12').addClass('balloons-rotate-behaviour-one');
		// $('#b13').addClass('balloons-rotate-behaviour-two');
		loopOne();
		loopTwo();
		loopThree();
		loopFour();
